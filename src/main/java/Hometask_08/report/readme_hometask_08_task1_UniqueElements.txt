...
Пользовательский ввод с обработкой ошибок
Возможность ввода любого количества элементов
Команда 'stop' для завершения ввода
Проверка на пустой ввод
Подробный вывод результатов с статистикой
